...
if($loginFailed){
    ...
    Display::addFlash(Display::return_message(get_lang('PleaseEnterValidLogin'), 'error'));
}
...
$controller->tpl->assign('access_url_description', api_get_access_url(api_get_current_access_url_id())['description']);
...
$controller->display_hot_course_item();
