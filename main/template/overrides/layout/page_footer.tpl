<div id="footer">
    ...
    <section class="sub-footer">
        ...
        <p>
            ...
            <strong><a href="https://www.superdemain.fr/" title="Site de Super Demain" target="_blank">Super Demain</a></strong>
        ...
        <p>
            ...
            vous donne l'autorisation de copier et d'utiliser l'ensemble des contenus pédagogiques développés pour
            <strong><a href="https://numerique-en-communs.fr/" title="Site de Numérique En Commun" target="_blank">Numérique En Commun</a></strong>
            . La plateforme a été développée grâce à
            <strong><a href="https://chamilo.org/fr/chamilo/" title="Site de Chamilo" target="_blank">Chamilo</a></strong>
            , et le soutien de Zoomacom et Openscop.
        </p>
