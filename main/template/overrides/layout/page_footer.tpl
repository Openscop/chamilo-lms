<div id="footer">
    ...
    <section class="sub-footer">
        ...
        <p>
            Les ressources de la plateforme sont mises à disposition sous les termes de la licence CC BY-SA 2.0 dans le cadre de
            <a href="https://numerique-en-communs.fr/" title="Site de Numérique en Communs" target="_blank">Numérique en Commun[s]</a>.
            Elles ont été produite par
            <a href="https://www.frequence-ecoles.org/" title="Site de Fréquence Écoles" target="_blank">Fréquence Écoles</a>,
            avec le soutien financier du programme
            <a href="https://agence-cohesion-territoires.gouv.fr/societe-numerique-55" title="Site de Société Numérique de l’Agence Nationale de la Cohésion des Territoires" target="_blank">Société Numérique de l’Agence Nationale de la Cohésion des Territoires</a>
             et la mobilisation de
            <a href="https://lamednum.coop/" title="Site de La Mednum" target="_blank">La MedNum</a>.
            La plateforme a été développée grâce à
            <a href="https://chamilo.org/fr/chamilo/" title="Site de Chamilo" target="_blank">Chamilo</a>,
            et le soutien de
            <a href="https://www.zoomacom.org/" title="Site de Zoomacom" target="_blank">Zoomacom</a>
