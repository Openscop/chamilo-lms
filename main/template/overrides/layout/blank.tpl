...
<main id="main" dir="{{ text_direction }}" class="{{ section_name }} {{ login_class }}">
    ...
    <section id="cm-content">
        <div class="container-fluid" style="margin: 0 40px;">
            <div class="row">
                <h1 class="homepage-title">Bienvenue dans l’espace de formation de Super Demain produit pour vous permettre de suivre des parcours en ligne contenant des vidéos explicatives, des interviews, des exercices à faire et des fiches à télécharger,...</h1>
            </div>
