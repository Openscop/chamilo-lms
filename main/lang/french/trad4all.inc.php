...
$IssuerDetails = "Détails émetteur·euse des badges";
$CreateBadge = "Créer un badge";
$Badges = "Badges";
$StudentsWhoAchievedTheSkillX = "Apprenant·es qui ont acquis la compétence %s";
$AchievedSkillInCourseX = "Compétences acquises grâce au cours %s";
$SkillsReport = "Rapport de compétences";
$AssignedUsersListToStudentBoss = "Liste des utilisateur·trices assigné·es au supérieur";
$AssignUsersToBoss = "Assigner des utilisateur·trices au supérieur";
$RoleStudentBoss = "Tuteur·trice d'apprenant·e";
...
$EditUserListCSV = "Éditer utilisateur·trices par CSV";
...
$QuestionEditionNotAvailableBecauseItIsAlreadyAnsweredHoweverYouCanCopyItAndModifyTheCopy = "L'édition de cette question est désactivée parce qu'elle a déjà été utilisée par au moins un·e étudiant·e dans un test. Cependant, vous pouvez la copier et modifier la copie.";
$SessionDurationDescription = "La durée de la session vous permet d'établir une durée en nombre de jours d'accès depuis le premier accès de l'étudiant·e à cette session. Tant que l'étudiant·e n'y entre pas, la durée n'est pas entamée. De cette manière, il vous est possible de définir une session qui durera '15 jours' au lieu de démarrer ou de terminer à une date spécifique.";
...
$CoachAndStudent = "Coach et apprenant·e";
$Serie = "Série";
...
$TeacherTimeReport = "Rapport de temps des enseignant·es";
$HyperbolicArcsineArcsinh = "Arcsinus hyperbolique:\t\tarcsinh(x)";
$YourLanguageNotThereContactUs = "Votre langue n'est pas dans la liste ? Contactez-nous à info@chamilo.org pour contribuer en tant que traducteur·trice !";
...
$UserNameHasDash = "Le nom d'utilisateur·trice ne peut pas contenir de tirets (-)";
...
$UserIsCurrentlySubscribed = "L'utilisateur·trice est inscrit·e en ce moment";
$OnlyBestAttempts = "Uniquement les meilleures tentatives";
$IncludeAllUsers = "Inclure tou·tes les utilisateur·trices";
...
$AddMeAsTeacherInCourses = "Ajoutez-moi tant que professeur·euse dans les cours";
$ExerciseProgressInfo = "Progrès des exercices passés par l'étudiant·e";
$CourseTimeInfo = "Temps passé dans le cours";
$ExerciseAverageInfo = "Moyenne du meilleur résultat de chaque tentative d'exercice";
$ExtraDurationForUser = "Jours d'accès extra pour cet·te utilisateur·trice";
$UserXSessionY = "Utilisateur·trice : %s - Session: %s";
$DurationIsSameAsDefault = "La durée configurée pour la session est celle par défaut. Valeur par défaut enregistrée.";
$FirstAccessWasXSessionDurationYEndDateWasZ = "Le premier accès de cet·te étudiant·e à cette session a eu lieu le %s. D'une durée maximum de %s jours, la période d'accès à cette session est déjà expirée.";
$FirstAccessWasXSessionDurationYEndDateInZDays = "Le premier accès de cet·te étudiant·e à cette session a eu lieu le %s. D'une durée maximum de %s jours, la fin est programmée pour dans %s jours.";
$UserNeverAccessedSessionDefaultDurationIsX = "Cet·te utilisateur·trice n'est jamais entré·e dans cette session auparavant. La durée est configurée pour %s jours (depuis la date de premier accès).";
$SessionDurationEdit = "Éditer la durée de la session";
$EditUserSessionDuration = "Éditer la durée de la session de l'utilisateur·trice";
...
$UsersWithoutTask = "Apprenant·es n'ayant pas envoyé leur travail";
$UsersWithTask = "Apprenant·es ayant envoyé leur travail";
...
$UserMustHaveTheDrhRole = "Les utilisateur·trices doivent être des DRH";
$NothingToAdd = "Rien à ajouter";
$NoStudentsFoundForSession = "Pas d'apprenant·es pour la session";
...
$ErrorWritingXMLFile = "Une erreur est survenue lors de l'écriture du fichier XML. Veuillez demander à votre administrateur·trice de vérifier les rapports d'erreurs.";
$TeacherXInSession = "Enseignant·e de session: %s";
...
$Coaches = "Tuteur·trices";
$ShowDescription = "Montrer la description";
$HumanResourcesManagerShouldNotBeRegisteredToCourses = "Les DRH ne devraient pas être inscrit·es directement à des cours (elles/ils doivent les 'suivre'). Les utilisateur·trices de ce type n'ont pas été inscrit·es.";
$CleanAndUpdateCourseCoaches = "Vider et mettre à jours les tuteur·trices";
...
$SubscribeTeachersToSession = "Inscrire des enseignant·es à des sessions";
$SubscribeStudentsToSession = "Inscrire des apprenant·es à des sessions";
...
$SendToUsersInSessions = "Envoyer aux utilisateur·trices de toutes les sessions de ce cours";
$ParametersNotFound = "Paramètres non trouvés";
$UsersToAdd = "Utilisateur·trices à ajouter";
$DocumentsAdded = "Documents ajoutés";
$NoUsersToAdd = "Aucun·e utilisateur·trice à ajouter";
...
$ClassIdDoesntExists = "La classe d'id %s n'existe pas. L'utilisateur·trice ci-après n'a pas été inscrit·e à la plateforme.";
...
$FollowedHumanResources = "DRH suivi·es";
...
$FollowedStudents = "Étudiant·es suivi·es";
$FollowedTeachers = "Enseignant·es suivi·es";
...
$AreYouSureDeleteTestResultBeforeDateD = "Êtes-vous sûr·e de vouloir supprimer toutes les tentatives antérieures à la date sélectionnée ?";
...
$ForumContent = "<p>Le forum est un outil de discussion asynchrone par écrit. À la différence du courriel, le forum situe la discussion dans un espace public ou semi-public (à plusieurs).</p><p>Pour utiliser l'outil de forum de Chamilo, les membres n'ont besoin que d'un simple navigateur Web, pas besoin d'outil de courriel.</P> <p>Pour organiser les forums, cliquez sur 'administrer'. Les échanges sont organisés de façon hiérarchique selon l'arborescence suivante :</p><p><b>Catégorie > Forum > Sujet > Réponse</b></p>Pour permettre aux membres de discuter de façon structurée, il est indispensable d'organiser les échanges préalablement en catégories et forums (à elles/eux de créer sujets et réponses). Par défaut, le forum contient uniquement la catégorie Public, un sujet d'exemple et un message exemple. Vous pouvez ajouter des forums dans la catégorie public, ou bien modifier son intitulé ou encore créer d'autres catégories dans lesquelles il vous faudra alors créer de nouveaux forums. Une catégorie qui ne contient aucun forum ne s'affiche pas et est inutilisable.</p> <b>Forums de groupes</b> <p>Pour créer des forums de groupes, utilisez l'outil Groupes et non l'outil Forums. Cela vous permettra de créer des forums privatifs (non accessibles aux membres des autres groupes) et de fournir simultanément un espace de documents aux groupes.</p> <p><b>Astuces pédagogiques</b></p> Un forum d'apprentissage n'est pas identique aux forums que l'on trouve habituellement sur internet. D'une part il n'est pas possible pour les apprenant·es de modifier leurs messages une fois publiés car le cours suit une logique d'archivage et peut être utilisé pour vérifier ce qui a été dit dans le passé. Par ailleurs, les forums Chamilo permettent certains usages particulièrement pertinents dans un contexte d'apprentissage. Ainsi certain·es enseignant·es/formateur·trices publient directement dans les forums leurs corrections : <ul><li>Un·e apprenant·e est invité·e à publier un rapport directement dans le forum,</li> <li>L'enseignant·e le corrige en cliquant sur Editer (crayon jaune) puis introduit ses corrections à l'aide de l'éditeur graphique : couleur, soulignage etc.,</li> <li>Finalement, les autres apprenant·es profitent de la correction qui a été faite sur la production de l'un·e d'entre elles/eux,</li> <li>Notez que le même principe peut être utilisé d'un apprenant à l'autre, mais il faudra alors copier/coller le message de sa/son condisciple car les étudiant·es/stagiaires ne peuvent éditer les messages des autres apprenant·es.<.li></ul>";
$HForum = "Aide Forums";
$LoginToGoToThisCourse = "Veuillez vous connecter pour accéder au cours";
$AreYouSureToEmptyAllTestResults = "Êtes-vous certain·e de vouloir supprimer les résultats de tous les exercices ?";
$CleanAllStudentsResultsForAllTests = "Supprimer tous les résultats de tous les exercices";
$AdditionalMailWasSentToSelectedUsers = "Une nouvelle annonce a été créée et envoyée à des utilisateur·trices sélectionné·es";
$LoginDate = "Date de connexion";
$ChooseStartDateAndEndDate = "Choisissez les dates de début et de fin";
$TestFeedbackNotShown = "Ce test est configuré pour ne pas montrer les commentaires (feedbacks) aux apprenant·es. Les commentaires des réponses aux questions ne seront pas affichés à la fin de ce test.";
$WorkAdded = "Travail ajouté";
$FeedbackDisplayOptions = "Détermine la manière dont se montreront les commentaires (feedback) enregistrés pour chacune des alternatives des questions présentées à l'apprenant·e. Nous recommandons fortement l'évaluation de ces différents modes de feedback avant d'inviter les apprenant·es à passer le test.";
$InactiveUsers = "Utilisateur·trices au compte désactivé";
$ActiveUsers = "Utilisateur·trices actif·ves";
...
$ChooseStudent = "Choisir un·e étudiant·e";
$SearchStudent = "Rechercher utilisateur·trices";
...
$DisplayAccessOverview = "Rapport d'accès par utilisateur·trice";
...
$DeleteUsersNotInList = "Désinscrite les apprenant·es qui ne sont pas dans la liste importée";
...
$GlobalLinkUseDoubleColumnPrivateToShowPrivately = "Utiliser ::private à la fin du lien pour l'afficher seulement aux utilisateur·trices identifié·es";
$NumberOfGroupsToCreate = "Nombre de groupes pour créer";
$CoachesSubscribedAsATeacherInCourseX = "Coaches souscrites comme enseignant·es dans le cours %s";
$EnrollStudentsFromExistingSessions = "Inscrivez étudiant·es de sessions existantes";
$EnrollTrainersFromExistingSessions = "Inscrivez formateur·trices de sessions existantes";
$AddingStudentsFromSessionXToSessionY = "Ajout des étudiant·es de la session %s à la session %s";
...
$ManageUserGroup = "Gérer les groupes d'utilisateur·trices";
$FolderDoesntExistsInFileSystem = "Le dossier de destination est introuvable sur le serveur.";
$RegistrationDisabled = "Désolé, vous essayez d'accéder à la page d'inscription pour ce portail, mais l'inscription est désactivée. Contactez l'administrateur·trice (voir les coordonnées en bas de page). Si vous avez déjà un compte sur ce site.";
$CasDirectCourseAccess = "Accèder au cours avec l'authentification CAS";
$TeachersWillBeAddedAsCoachInAllCourseSessions = "Les enseignant·es seront ajouté·es en tant que coach à toutes les sessions de cours.";
...
$YouAreReg = "Vous êtes inscrit·e à";
...
$FieldLoggeable = "Les changements de ce champ vont être sauvegardés.";
...
$CourseVisibilityHidden = "Invisible - Complètement invisible et inaccessible pour tous les utilisateur·trices excepté les administrateur·trices";
...
$YourPasswordCannotBeTheSameAsYourUsername = "Votre mot de passe ne peut être identique à votre nom d'utilisateur·trice";
...
$OrderedByUser = "Ordonné par utilisateur·trice";
$ToReview = "À réviser";
$Unanswered = "Non répondues";
$CurrentQuestion = "Question actuelle";
$MediaQuestions = "Énoncés partagés";
$CourseCategoriesAreGlobal = "Les catégories de cours sont globales par rapport aux configurations multi-portails. Les modifications ne sont autorisées qu'à l'administrateur·trice global·e du portail administratif.";
$CareerUpdated = "Carrière mise à jour";
$UserIsNotATeacher = "L'utilisateur·trice n'est pas un enseignant·e";
...
$AllUsersOfThePlatform = "Tou·tes les utilisateur·trices du portail";
...
$ItemForUserSelection = "Liste de sélection des utilisateur·trices";
...
$AreYouSureToDeleteSteps = "Êtes-vous certain·e de vouloir supprimer ces étapes ?";
$Origin = "Origine";
$Local = "Local";
$Remote = "Distant";
$FileToUpload = "Fichier à envoyer";
$ContentMaker = "Créateur·trice du contenu";
...
$SureYouWantToDeleteSelectedMessages = "Êtes-vous certain·e de vouloir supprimer les messages sélectionnés ?";
...
$ConfirmDeleteMessage = "Êtes-vous certain·e de vouloir supprimer le message sélectionné ?";
$DeleteMessage = "Supprimer le message";
$ReadMessage = "Lire";
$SendInviteMessage = "Envoyer invitation";
$SendMessageInvitation = "Êtes-vous sûr·e de vouloir envoyer ces invitations ?";
...
$OpenToThePlatform = "Ouvert - accès autorisé aux utilisateur·trices enregistré·es sur la plateforme";
$StudentXIsNotSubscribedToCourse = "L'étudiant·e %s n'est pas inscrit·e dans ce cours";
$TipLang = "Cette langue vaudra pour tou·tes les visiteur·euses de votre cours.";
$Vid = "Vidéo";
$Work = "Travaux";
...
$ByDel = "En supprimant ce cours, vous supprimerez tous les documents qu'il contient et désinscrirez tou·tes les membres qui y sont inscrit·es. <p>Voulez-vous réellement supprimer ce cours ?";
$Y = "OUI";
$N = "NON";
...
$RestoreNotice = "Ce script ne permet pas encore la restauration automatique des utilisateur·trices, mais les données sauvegardées dans le fichier \"users.csv\" sont suffisantes pour que l'administrateur·trice puisse effectuer cette opération manuellement.";
...
$CourseVisibilityClosed = "Complètement fermé - le cours est uniquement accessible pour son administrateur·trice";
...
$AllowUserEditAgenda = "Autoriser les utilisateur·trices à éditer l'agenda du cours";
$AllowUserEditAgendaActivate = "Activer l'édition de l'agenda du cours par les utilisateur·trices";
$AllowUserEditAgendaDeactivate = "Désactiver l'édition de l'agenda du cours par les utilisateur·trices";
$AllowUserEditAnnouncement = "Autoriser les utilisateur·trices à éditer les annonces du cours";
$AllowUserEditAnnouncementActivate = "Activer l'édition par les utilisateur·trices";
$AllowUserEditAnnouncementDeactivate = "Désactiver l'édition par les utilisateur·trices";
$OrInTime = "Soit dans";
...
$AllowUserImageForum = "Photo utilisateur·trice dans le forum";
$AllowUserImageForumActivate = "Afficher les photos des utilisateur·trices dans le forum";
$AllowUserImageForumDeactivate = "Ne pas afficher les photos des utilisateur·trices dans le forum";
...
$NewUserEmailAlertToTeacharAndTutor = "Activer l'alerte par courriel aux enseignant·es et aux formateur·trices lors de l'inscription autonome d'un·e nouvel·le apprenant·e";
...
$NoDestinationCoursesAvailable = "Il n'y a pas d'autre cours dont vous soyez l'administrateur·trice. Vous ne pouvez en conséquence pas copier de contenu vers un autre cours.";
...
$ArchivesDirectoryNotWriteableContactAdmin = "Le répertoire app/cache/, utilisé par cet outil, ne dispose pas des accès en écriture. Veuillez contacter l'administrateur·trice de la plateforme à ce sujet.";
$DestinationCourse = "Cours de destination";
$ConvertToMultipleAnswer = "Convertir en question à réponses multiples (QRM)";
$CasMainActivateComment = "Activer l'authentification CAS permettra aux utilisateur·trices de s'identifier à l'aide de leur compte CAS<br/>Vous trouverez dans les <a href='settings.php?category=CAS'>Plugin</a> un bouton 'Login CAS', paramétrable, qui s'ajoutera sur la page d'accueil de votre campus Chamilo. Alternativement, vous pouvez forcer l'authentification CAS en définissant cas[force_redirect] dans app/config/auth.conf.php.";
$UsersRegisteredInAnyGroup = "Utilisateur·trices enregistré·es dans n'importe quel groupe";
$Camera = "Caméra";
$Microphone = "Micro";
...
$UsersNow = "Utilisateur·trices actuellement:";
...
$InfoConnectedUsersGetNotifiedOfThisPoll = "Info: tout·e utilisateur·trice connecté·e dans cette chambre recevra le sondage.";
$YesNo = "Oui/non";
$Numeric1To10 = "Numérique de 1 à 10";
$Poll = "Sondage";
$YouHaveToBecomeModeratorOfThisRoomToStartPolls = "Vous devez être modérateur·trice pour créer des sondages.";
...
$AlreadyIn = "Déjà connecté·es";
$CheckIn = "Déjà connecté·es";
$TheModeratorHasLeft = "Lae modérateur·trice a quitté la conférence.";
...
$ApplyForModeration = "Demander à être modérateur·trice";
$Apply = "Appliquer";
$BecomeModerator = "Devenir modérateur·trice";
$Italic = "Italiques";
$Bold = "Grasses";
$Waiting = "En attente";
$AUserWantsToApplyForModeration = "Un·e utilisateur·trice demande à être modérateur·trice :";
$Reject = "Rejeter";
$SendingRequestToFollowingUsers = "Requête envoyée aux utilisateur·trices suivant·es";
$Accepted = "Accepté·e";
$Rejected = "Rejeté·e";
$ChangeModerator = "Changer de modérateur·trice";
$YouAreNotModeratingThisCourse = "Vous n'êtes pas modérateur·trice !";
...
$SynchronisingConferenceMembers = "Synchronisation des participant·es";
$Trainer = "Formateur·trice";
$Slides = "Diapositives";
$WaitingForParticipants = "En attente de participant·es";
$Browse = "Parcourir";
...
$ThisItemIsInvisibleForStudentsButYouHaveAccessAsTeacher = "Cet élément est invisible pour les étudiant·es mais vous avez un accès enseignant·e.";
$PreventSessionAdminsToManageAllUsersTitle = "Empêcher les administrateur·trices de session de gérer tous les utilisateur·trices";
...
$AddedToLPCannotBeAccessed = "Cet exercice fait partie d'un parcours d'apprentissage, il n'est donc pas accessible par les étudiant·es depuis cette page. Si vous voulez rendre cet exercice disponible depuis l'outil exercice, vous devez en faire une copie en utilisant l'icône \"Copie\"";
...
$Ridiculise = "Ridiculiser sa/son interlocuteur·trice pour lui faire admettre son erreur.";
...
$Force = "Contraindre sa/son interlocuteur·trice, par une série de questions et de sous-questions, à reconnaître qu'iel ne connaît pas ce qu'iel prétend connaître.";
$Indeed = "En effet. L'ironie socratique est une méthode interrogative. Le grec \"eirotao\" signifie d'ailleurs \"interroger\".";
$Contradiction = "Utiliser le principe de non-contradiction pour amener sa/son interlocuteur·trice dans l'impasse.";
$NotFalse = "Cette réponse n'est pas fausse. Il est exact que la mise en évidence de l'ignorance de l'interlocuteur·trice se fait en mettant en évidence les contradictions auxquelles abouttisent ses thèses.";
...
$MailTemplateRegistrationTitle = "Nouvel·le inscrit·e sur ((sitename))";
$Unsubscribe = "Désinscription";
$AlreadyRegisteredToCourse = "Vous êtes déjà enregisté·e dans ce cours";
...
$StudentsCanEdit = "Autoriser les apprenant·es à éditer leurs propres articles ?";
$ApprovalDirect = "Approbation / Publication directe";
$AllowNewThreads = "Autoriser les apprenant·es à ouvrir de nouveaux sujets de discussion ?";
...
$ReplyToThread = "Envoyer";
$QuoteMessage = "Citer ce message";
$NewTopic = "Nouveau sujet";
$Views = "Vues";
$LastPost = "Dernier article";
$Quoting = "Citation";
$NotifyByEmail = "Me prévenir par courriel si quelqu'un·e répond à ce message";
$StickyPost = "C'est un message \"Post it\" (il apparaît toujours au premier plan)";
$ReplyShort = "Re:";
$DeletePost = "Êtes-vous certain·e de vouloir détruire cet article ? Ceci détruirait également toutes les réponses qui y ont été faites. Veuillez vérifier dans la vue thématique quels autres articles seront également détruits.";
...
$YouWantedToStayInformed = "Vous avez exprimé le désir d'être informé·e par mail chaque fois qu'une réponse est ajoutée à la discussion.";
$MessageHasToBeApproved = "Votre message devra être approuvé par lae modérateur·trice avant d'être publié.";
...
$ThreadUsersList = "Liste des utilisateur·trices du fil";
$QualifyThisThread = "Noter ce fil";
$CourseUsers = "Utilisateur·trices du cours";
$PostsNumber = "Nombre de messages";
$NumberOfPostsForThisUser = "Nombre de messages de l'utilisateur·trice";
$AveragePostPerUser = "Moyenne messages par utilisateur·trice";
...
$AllStudents = "Tou·tes les apprenant·es";
$StudentsQualified = "Apprenant·es coté·es";
$StudentsNotQualified = "Apprenant·es non coté·es";
...
$NotifyMe = "M'alerter";
$ConfirmUserQualification = "Confirmer cote apprenant·e";
...
$ModifyThread = "Modifier le sujet";
...
$AllowSelfRegProf = "Autoriser l'auto-inscription en tant que créateur·trice de cours";
$EG = "par ex.";
$DBHost = "Hôte base de données";
$DBLogin = "Utilisateur·trice base de données";
...
$AdminEmail = "Email de l'administrateur·trice";
$AdminName = "Nom de l'administrateur·trice";
$AdminSurname = "Prénom de l'administrateur·trice";
$AdminLogin = "Identifiant de l'administrateur·trice";
$AdminPass = "Mot de passe de l'administrateur·trice (<font color=\"red\">en choisir un autre pourrait être une bonne idée</font>)";
$EducationManager = "Responsable du contenu";
$CampusName = "Nom du campus";
$DBSettingIntro = "Le script d'installation créera (ou utilisera) la base de données de Chamilo avec le nom donné ici. Merci de vous assurer que l'utilisateur·trice indiqué dispose des droits suffisants pour créer la base de données. Si une base de données de ce nom existe déjà, ses données seront écrasées. N'utilisez pas l'utilisateur·trice root comme utilisateur de base de données pour Chamilo : cela peut ouvrir la porte à de sérieux problèmes de sécurité.";
$TimeSpentByStudentsInCourses = "Temps passé par les étudiant·es dans les cours";
$Step3 = "Étape 3 sur 6";
$Step4 = "Étape 4 sur 6";
$Step5 = "Étape 5 sur 6";
$Step6 = "Étape 6 sur 6";
...
$EncryptUserPass = "Crypter les mots de passes des utilisateur·trices dans la base de données";
$SingleDb = "Utiliser une ou plusieurs bases de données pour Chamilo";
$AllowSelfReg = "Auto-inscription autorisée";
$Recommended = "(recommandé)";
$ScormDB = "BdD Scorm";
$AdminLastName = "Nom de l'administrateur·trice";
$AdminPhone = "Téléphone de l'administrateur·trice";
...
$NoteConfirmDelete = "Êtes-vous certain·e de vouloir supprimer cette note ?";
...
$Titular = "Responsable";
$SendToAllUsers = "Envoyer à tou·tes";
$AdministrationTools = "Outils d'administration";
$CatList = "Catégories";
$Subscribe = "S'inscrire";
$AlreadySubscribed = "Déjà inscrit·e";
$CodeMandatory = "Code requis";
$CourseCategoryMandatory = "Catégorie de cours requise";
$TeacherMandatory = "Formateur·trice requis·e";
$CourseCategoryStored = "Catégorie créée";
$WithoutTimeLimits = "Sans limite de temps";
$Added = "Ajouté·es";
$Deleted = "Supprimé·es";
$Keeped = "Conservé·es";
$HideAndSubscribeClosed = "Masqué·e / Fermé·e";
$HideAndSubscribeOpen = "Masqué·e / Ouvert·e";
$ShowAndSubscribeOpen = "Visible / Ouvert·e";
$ShowAndSubscribeClosed = "Visible / Fermé·e";
...
$CourseAdminUnsubscribeNotAllowed = "Vous êtes l'administrateur·trice de ce cours.";
...
$CourseCategoryAbout2bedeleted = "Êtes-vous certain·e de vouloir supprimer cette catégorie de cours ? Les cours de cette catégorie seront déplacés en dehors de toute catégorie de cours.";
...
$ConfirmUnsubscribeFromCourse = "Êtes-vous certain·e de vouloir vous désinscrire de ce cours ?";
...
$YouAreNowUnsubscribed = "Vous êtes maintenant désinscrit·e du cours";
$ViewOpenCourses = "Voir les cours ouverts";
$ErrorContactPlatformAdmin = "Une erreur inconnue est survenue. Contactez l'administrateur·trice.";
...
$AllowTeachersToCreateSessionsComment = "Les enseignant·es peuvent créer, éditer et supprimer leurs propres sessions.";
$AllowTeachersToCreateSessionsTitle = "Permettre aux enseignant·es de créer des sessions";
...
$Schedule = "Horaire";
$Place = "Lieu";
$RecommendedNumberOfParticipants = "Nombre recommandé de participant·es";
...
$CreateUser = "Créer utilisateur·trice";
$ModifyUser = "Modifier l'utilisateur·trice";
$buttonEditUserField = "Éditer le champ utilisateur·trice";
...
$DBManagementOnlyForServerAdmin = "La gestion des bases de données n'est accessible qu'à l'administrateur·trice du serveur";
$ShowUsersOfCourse = "Afficher les utilisateur·trices inscrit·es au cours";
...
$XComments = "Les résultats éventuels des enseignant·es ne sont ni affichés ni pris en compte dans l'outil d'évaluations.";
$AddUsers = "Ajouter des utilisateur·trices";
$AddGroups = "Ajouter des groupes";
$AddClasses = "Ajouter des classes";
$ExportUsers = "Exporter les utilisateur·trices";
$NumberOfParticipants = "Nombre de participant·es";
$NumberOfUsers = "Nombre d'utilisateur·trices";
...
$ModifyUserInfo = "Modifier les informations d'un utilisateur·trice";
...
$PleaseEnterLastName = "Veuillez saisir le nom de l'utilisateur·trice !";
$PleaseEnterFirstName = "Veuillez saisir le prénom de l'utilisateur·trice !";
...
$PleaseEnterTitularName = "Veuillez saisir le nom de la/du responsable !";
...
$ImportUserListXMLCSV = "Import d'utilisateur·trices au format XML/CSV";
$ExportUserListXMLCSV = "Export des utilisateur·trices au format XML/CSV";
$OnlyUsersFromCourse = "Seulement les utilisateur·trices du cours";
$AddClassesToACourse = "Inscrire des classes d'utilisateur·trices à un cours";
$AddUsersToACourse = "Inscrire des utilisateur·trices à un cours";
$AddUsersToAClass = "Inscrire des utilisateur·trices dans une classe";
$AddUsersToAGroup = "Inscrire des utilisateur·trices à un groupe";
$AtLeastOneClassAndOneCourse = "Vous devez sélectionner au moins une classe et un cours !";
$AtLeastOneUser = "Vous devez sélectionner au moins un·e utilisateur·trice !";
$AtLeastOneUserAndOneCourse = "Vous devez sélectionner au moins un·e utilisateur·trice et un cours !";
...
$UsersOutsideClass = "Utilisateur·trices en dehors de la classe";
$UsersInsideClass = "Utilisateur·trices dans la classe";
$UsersOutsideGroup = "Utilisateur·trices en dehors du groupe";
$UsersInsideGroup = "Utilisateur·trices dans le groupe";
...
$MaxImportUsers = "Vous ne pouvez pas importer plus de 500 utilisateur·trices à la fois !";
$AdminDatabases = "Bases de données (phpMyAdmin)";
$AdminUsers = "Utilisateur·trices";
$AdminClasses = "Classes d'utilisateur·trices";
$AdminGroups = "Groupes d'utilisateur·trices";
$AdminCourses = "Cours";
$AdminCategories = "Catégories de cours";
$SubscribeUserGroupToCourse = "Inscrire un·e utilisateur·trice / groupe à un cours";
...
$MailTo = "Contact :";
$AddAdminInApache = "Ajouter un·e administrateur·trice";
$AddFaculties = "Ajouter des catégories";
$SearchACourse = "Rechercher un cours";
$SearchAUser = "Rechercher un·e utilisateur·trice";
...
$UsersNumber = "Nombre d'utilisateur·trices";
$PublicAdmin = "Administration Publique";
$PageAfterLoginTitle = "Page d'accueil des utilisateur·trices identifié·es";
$PageAfterLoginComment = "Page vers laquelle est redirigé un·e utilisateur·trice qui se connecte";
...
$PDFDownloadNotAllowedForStudents = "Les apprenant·es ne peuvent pas télécharger un PDF";
...
$SendMailToUsers = "Envoyer un mail aux utilisateur·trices";
...
$PlatformLanguagesExplanation = "Cet outil gère le menu de sélection des langues sur la page de login. En tant qu'administrateur·trice de la plateforme, vous pouvez décider quelles langues seront disponibles pour les utilisateur·trices.";
...
$emailAdministratorTitle = "Administrateur·trice de la plateforme : Courriel";
$emailAdministratorComment = "L'adresse de courriel de l'administrateur·trice de la plateforme (apparaît dans le pied de page du côté gauche)";
$administratorSurnameTitle = "Administrateur·trice de la plateforme : nom de famille";
$administratorSurnameComment = "Le nom de famille de l'administrateur·trice de la plateforme (apparaît dans le pied de page du côté gauche)";
$administratorNameTitle = "Administrateur·trice de la plateforme : prénom";
$administratorNameComment = "Le prénom de l'administrateur·trice de la plateforme (apparaît dans le pied de page, du côté gauche)";
$ShowAdministratorDataTitle = "Informations de l'administrateur·trice de la plateforme dans le pied de page";
$ShowAdministratorDataComment = "Afficher les informations sur l'administrateur·trice de la plateforme dans le pied de page ?";
...
$ShowStudentViewTitle = "Vue apprenant·e";
$ShowStudentViewComment = "Activer la vue étudiant·e ?<br />Cette fonctionnalité permet à l'enseignant de voir ce qu'un·e étudiant·e verrait.";
$AllowGroupCategories = "Catégories de groupes";
$AllowGroupCategoriesComment = "Autoriser les administrateur·trices de cours à créer des catégories dans l'outil \"groupes\" du cours";
...
$AllowNameChangeComment = "L'utilisateur·trice est-iel autorisé·e à changer son prénom et son nom de famille ?";
...
$AllowUserHeadingsComment = "Est-ce qu'un·e administrateur·trice peut définir des en-têtes pour obtenir des informations supplémentaires relatives aux utilisateur·trices ?";
...
$LimitUsersListDefaultMaxComment = "Dans les écrans d'inscription des utilisateur·trices aux cours ou aux classes, si le nombre d'utilisateur·trices dans la liste non filtrée, lors du premier chargement, dépasse ce nombre, alors filtrer par défaut à la première lettre (A)";
...
$UserDeleted = "L'utilisateur·trice a été supprimé·e";
$NoClassesForThisCourse = "Aucune classe n'est inscrite à ce cours";
$CourseUsage = "Utilisation du cours";
$NoCoursesForThisUser = "Cet·te utilisateur·trice n'est pas inscrit·e dans un cours";
$NoClassesForThisUser = "Cet·te utilisateur·trice n'est pas inscrit·e dans une classe";
...
$AllowPersonalAgendaComment = "L'utilisateur·trice peut-iel ajouter des éléments d'agenda personnels sur la page 'Mon agenda'?";
$CurrentValue = "Valeur actuelle";
$AlreadyRegisteredToSession = "Vous êtes déjà inscrit·e à la session";
...
$StudentPublications = "Travaux d'étudiant·es";
...
$DropboxAllowOverwriteComment = "Le document d'origine peut-il être écrasé lorsqu'un·e utilisateur·trice transfère un document portant le même nom ? En répondant OUI, vous perdez la possibilité de conserver les versions successives du document";
$DropboxAllowJustUploadTitle = "Partage de fichiers: autoriser l'envoi de documents à soi-même";
$DropboxAllowJustUploadComment = "Autoriser les enseignant·es et les étudiant·es à télécharger des documents dans leur propre section de partage de fichiers sans les envoyer à personne d'autre.(S'envoyer des documents à soi-même.)";
$DropboxAllowStudentToStudentTitle = "Partage de fichiers: utilisateur·trice <-> utilisateur·trice";
$DropboxAllowStudentToStudentComment = "Permettre aux étudiant·es d'envoyer des documents aux autres étudiant·es (peer to peer). Attention : les étudiant·es pourraient utiliser cette fonctionnalité pour s'adresser des documents peu appropriés (mp3, solutions aux tests...). Désactiver cette fonctionnalité n'autorisera l'envoi de documents qu'à la/au professeur·euse.";
$DropboxAllowMailingTitle = "Partage de fichier : autoriser l'envoi par courriels";
$DropboxAllowMailingComment = "Avec la fonctionnalité d'envoi par courriel, vous pouvez adresser un document personnel à chaque utilisateur·trice";
...
$UserListHasBeenExported = "La liste des utilisateur·trices a été correctement exportée";
$ClickHereToDownloadTheFile = "Cliquer ICI pour télécharger le fichier";
$administratorTelephoneTitle = "Administrateur·trice de la plate-forme : téléphone";
$administratorTelephoneComment = "Coordonnées téléphoniques de l'administrateur·trice de la plate-forme";
$SendMailToNewUser = "Envoyer un courriel à la/au nouvel·le utilisateur·trice";
$ExtendedProfileTitle = "Utiliser le Profil Etendu";
$ExtendedProfileComment = "Si \"Oui\" est coché, l'utilisateur·trice pourra compléter les champs facultatifs suivants : \"Mes compétences\", \"Mes diplômes\", \"Mes compétences professionnelles\", \"Mon espace personnel\"";
$Classes = "Classes";
$UserUnsubscribed = "L'utilisateur·trice est maintenant désinscrit·e";
$CannotUnsubscribeUserFromCourse = "L'utilisateur·trice ne peut pas être désinscrit·e : iel est administrateur·trice de ce cours";
...
$DropboxAllowGroupComment = "Les utilisateur·trices sont autorisé·es à envoyer des fichiers aux groupes";
$ClassDeleted = "La classe a été supprimée";
$ClassesDeleted = "Les classes ont été supprimées";
$NoUsersInClass = "Cette classe ne comporte pas d'utilisateur·trice";
$UsersAreSubscibedToCourse = "Les utilisateur·trices sélectionné·es ont été inscrit·es au(x) cours correspondant(s)";
...
$Banner = "Bannière";
$ImageResizeTitle = "Redimentionnez les images des utilisateur·trices.";
$ImageResizeComment = "Les images téléchargées par les utilisateur·trices peuvent être redimensionnées si PHP a été compilé avec la <a href=\"http://php.net/manual/en/ref.image.php\" target=\"_blank\">librairie GD</a>. Si ce n'est pas le cas, ce réglage n'a aucun effet.";
...
$ShowEmailAddressesComment = "Afficher les adresses de courriel aux utilisateur·trices";
...
$ServerStatisticsDescription = "AWStats vous permet de consulter les statistiques de visites de la plateforme : visiteur·euses, pages vues, provenance des visiteur·euses...";
...
$Confirm = "Confirmer";
$UnsubscribeUsersFromCourse = "Désinscrire des utilisateur·trices du cours";
...
$StudentViewEnabledTitle = "Activer la vue étudiant·e";
$StudentViewEnabledComment = "Activer la vue étudiant·e, qui permet aux tuteur·trices ou administrateur·trices de voir le cours comme un·e étudiant·e le verrait";
$TimeLimitWhosonlineTitle = "Limite de temps sur WhoIsOnline";
$TimeLimitWhosonlineComment = "Cette limite de temps (en minutes) définit pendant combien de temps après sa dernière action enregistrée un·e utilisateur·trice est considéré *en ligne*";
...
$AccountValidDurationTitle = "Validité des comptes utilisateur·trices";
$AccountValidDurationComment = "Un nouveau compte utilisateur·trice est valide pendant ce nombre de jours après création";
$UseSessionModeTitle = "Utiliser les sessions";
$UseSessionModeComment = "Les sessions permettent de gérer les cours différemment. Chaque cours a un·e créateur·trice, des coaches et des étudiant·es. Un coach donne un cours donné pendant une période donnée, appelée \"session\", à un ensemble d'utilisateur·trices déterminé";
$HomepageViewActivity = "Vue activité";
$HomepageView2column = "Vue en deux colonnes";
$HomepageView3column = "Vue en trois colonnes";
$AllowUserHeadings = "Autoriser les en-têtes utilisateur·trices";
...
$SubscribeUserIfNotAllreadySubscribed = "Inscrire l'utilsateur·trice s'iel n'est pas déjà inscrit·e";
$UnsubscribeUserIfSubscriptionIsNotInFile = "Désinscrire l'utilisateur·trice de tous les cours auxquels iel n'est pas explicitement inscrit·e dans le fichier";
...
$NbUsers = "Utilisateur·trices";
$SubscribeUsersToSession = "Inscrire des utilisateur·trices à cette session";
$UserListInPlatform = "Liste des utilisateur·trices de la plateforme";
$UserListInSession = "Liste des utilisateur·trices inscrit·es à cette session";
$CourseListInPlatform = "Liste des cours de la plateforme";
$Host = "Hôte";
$UserOnHost = "Nom d'utilisateur·trice";
...
$Ajax_course_tracking_refresh_comment = "Cette option permet, en temps réel, de calculer le temps qu'un·e utilisateur·trice passe sur un cours. La valeur à indiquer dans ce champ est l'intervalle de rafraîchissement en secondes. Pour désactiver cette option, laissez la valeur à 0.";
...
$UserLocked = "Utilisateur·trice bloqué·e";
$UserUnlocked = "Utilisateur·trice débloqué·e";
$CannotDeleteUser = "vous ne pouvez paas supprimer cet·te utilisateur·trice";
$SelectedUsersDeleted = "Les utilisateur·trices sélectionné·es ont été supprimé·es";
$SomeUsersNotDeleted = "Certain·es utilisateur·trices n'ont pas été supprimé·es";
$ExternalAuthentication = "Authentification externe";
$RegistrationDate = "Date d'enregistrement";
$UserUpdated = "Utilisateur·trice mis à jour";
...
$UserNameUsedTwice = "Un nom d'utilisateur·trice est utilisé deux fois";
$UserNameNotAvailable = "Ce nom d'utilisateur·trice n'est pas disponible";
$UserNameTooLong = "Ce nom d'utilisateur·trice est trop long";
...
$UnknownUser = "Utilisateur·trice inconnu·e";
$UnknownStatus = "Statut inconnu";
$SessionDeleted = "La session a bien été supprimée";
$CourseDoesNotExist = "Ce cours n'existe pas";
$UserDoesNotExist = "Cet·te utilisateur·trice n'existe pas";
$ButProblemsOccured = "mais des problèmes sont survenus";
$UsernameTooLongWasCut = "Ce nom d'utilisateur·trice a été coupé";
$NoInputFile = "Aucun fichier envoyé";
$StudentStatusWasGivenTo = "Le statut étudiant·e a été attribué à";
...
$CourseTeachers = "Formateur·trices du cours";
$UnknownTeacher = "Formateur·trice inconnu";
$HideDLTTMarkup = "Cacher le marquage DLTT";
$ListOfCoursesOfSession = "Liste des cours de la session";
$UnsubscribeSelectedUsersFromSession = "Désinscrire les utilisateur·trices sélectionné·es de la session";
...
$ListOfUsersSubscribedToCourse = "Liste des utilisateur·trices inscrit·es au cours";
...
$NoSessionsForThisUser = "Cet·te utilisateur·trice n'est pas inscrit·e dans un cours";
...
$DefaultForumViewComment = "Quelle devrait être l'option par défaut lors de la création d'un nouveau forum ? Tout·e administrateur·trice de cours pourra cependant toujours choisir une vue différente pour chaque forum individuel";
...
$NoUsersForThisSession = "Pas d'utilisateur·trices pour cette session";
...
$ExtendedProfileRegistrationComment = "Parmi les champs suivants du profil étendu, lesquels doivent être disponibles lors du processus d'enregistrement des utilisateur·trices ? Ceci nécessite que le profil étendu lors de l'enregistrement soit activé (voir plus haut).";
$ExtendedProfileRegistrationRequiredTitle = "Champs du profil étendu demandés lors de l'enregistrement";
$ExtendedProfileRegistrationRequiredComment = "Parmi les champs du profil étendun lesquels sont requis lors de l'enregistrement des utilisateur·trices ? Ceci nécessite que l'option du profil étendu à l'enregistrement soit activée et que les champs soient disponibles dans le formulaire d'inscription (voir ci-dessus).";
...
$CourseCoachEmailSender = "Adresse de courriel du coach/tuteur·trice";
...
$InstallDirAccessibleSecurityThreat = "Le répertoire main/install est toujours accessible aux utilisateur·trices web. Ceci peut représenter un danger en termes de sécurité. Nous recommandons la suppression de ce répertoire ou le changement des permissions de telle manière que les utilisateur·trices web ne puissent plus utiliser les scripts qu'il contient.";
...
$UserThemeSelection = "Sélection du thème visuel par l'utilisateur·trice";
$UserThemeSelectionComment = "Autoriser le choix du style visuel par les utilisateur·trices. Ce paramètre permettra à chaque utilisateur·trice de choisir son propre style. Le style par défaut du portail restera toutefois inchangé. Si un cours ou une session dispose d'un style visuel qui lui est propre, celui-ci aura la priorité sur le style sélectionné par l'utilisateur·trice.";
...
$LDAPAuthenticationPasswordComment = "Dans le cas d'un serveur LDAP n'autorisant pas les accès anonymes, complétez le champ suivant avec le mot de passe de l'utilisateur·trice ayant accès au système.";
$LDAPImport = "Import LDAP";
$EmailNotifySubscription = "Avertir les utilisateur·trices inscrit·es par courriel";
...
$StepUsersDeletedSuccessfully = "Utilisateur·trices de l'étape supprimés avec succès";
$NoStepForThisSession = "Pas d'étape pour cette session de cours";
$DeleteStepUsers = "Supprimer les utilisateur·trices de cette étape";
$ImportStudentsOfAllSteps = "Importer les apprenant·es de toutes les étapes";
$ImportLDAPUsersIntoPlatform = "Importer des utilisateurs";
$NoUserInThisSession = "Pas d'utilisateur·trice dans cette session de formation";
$SubscribeSomeUsersToThisSession = "Inscrire des utilisateur·trices à cette session";
$EnterStudentsToSubscribeToCourse = "Saisissez les apprenant·es que vous voulez inscrire à votre cours";
...
$SelectStudents = "Sélection des apprenant·es";
$LDAPUsersAdded = "Utilisateur·trices LDAP ajouté·es";
$NoUserAdded = "Aucun·e utilisateur·trice ajouté";
$ImportLDAPUsersIntoCourse = "Importer des utilisateur·trices dans un cours";
$ImportLDAPUsersAndStepIntoSession = "Importer des utilisateurs et une étape LDAP dans une session de cours";
$LDAPSynchroImportUsersAndStepsInSessions = "Synchro LDAP : Import apprenant·es/étapes dans sessions de cours";
$TabsMyGradebook = "Onglet Cahier de notes";
$LDAPUsersAddedOrUpdated = "Utilisateur·es LDAP ajoutés ou mis à jour";
$SearchLDAPUsers = "Recherche d'utilisateur·trices LDAP";
$SelectCourseToImportUsersTo = "Sélectionnez le cours auquel vous voulez inscrire les utilisateur·trices";
$ImportLDAPUsersIntoSession = "Importer des utilisateur·trices dans une session de cours";
$LDAPSelectFilterOnUsersOU = "Sélectionnez un filtre permettant de trouver les utilisateur·trices dont l'attribut OU se termine par ce filtre";
$LDAPOUAttributeFilter = "Le filtre sur l'attribut OU";
$SelectSessionToImportUsersTo = "Sélectionnez la session de cours à laquelle vous voulez inscrire ces utilisateur·trices";
...
$LDAPFilledTutorFieldValueTitle = "Valeur d'identification d'un·e enseignant·e";
$LDAPFilledTutorFieldValueComment = "Lorsque la vérification du champ enseignant·e est faite sur le champ donné ci-dessus, la valeur donnée ci-dessous doit se trouver dans les sous-éléments du champ donné pour que l'utilisateur soit considéré comme un enseignant. Si vous laissez ce champ vide, la seule condition est que le sous-élément défini par le champ enseignant ci-dessus existe pour l'utilisateur LDAP pour qu'il soit considéré comme un·e enseignant·e. Par exemple, le champ pourrait être \"memberof\" et la valeur à trouver \"CN=G_TRAINER,OU=Trainer\".";
...
$AddUsersByCoachTitle = "Permettre l'enregistrement d'utilisateur·trices par les coachs";
$AddUsersByCoachComment = "Autoriser les coachs à ajouter des utilisateur·trices dans le portail et à les inscrire dans une session.";
...
$AddUrl = "Ajouter URL";
$ShowSessionCoachTitle = "Afficher lae coach de session";
$ShowSessionCoachComment = "Afficher le nom de la/du coach global·e de session dans le cadre de titre de session, sur la page de liste de cours";
$ExtendRightsForCoachTitle = "Donner des droits étendus à la/au coach";
$ExtendRightsForCoachComment = "Activer cette option donner aux coachs les mêmes droits qu'à la/au formateur·trice sur les outils de production";
$ExtendRightsForCoachOnSurveyComment = "Activer cette option donnera aux coachs le droit de créer et de modifier les enquêtes";
$ExtendRightsForCoachOnSurveyTitle = "Etendre les droits des coachs sur les enquêtes";
$CannotDeleteUserBecauseOwnsCourse = "Cet·te utilisateur·trice ne peut être supprimé·e car iel est toujours formateur·trice dans une ou plusieurs cours. Vous pouvez soit lui retirer son statut de formateur·trice dans ce cours, soit le désactiver au lieu de le supprimer.";
$AllowUsersToCreateCoursesTitle = "Autoriser les utilisateur·trices non-administrateur·trices à créer des cours";
$AllowUsersToCreateCoursesComment = "Autoriser les formateur·trices (non administrateur·trices) à créer des cours dans le portail";
$AllowStudentsToBrowseCoursesComment = "Permettre aux apprenant·es de voir le catalogue de formations librement afin de s'inscrire aux formations disponibles";
$YesWillDeletePermanently = "Oui (les fichiers seront supprimés de manière permanente et ne pourront pas être récupérés)";
$NoWillDeletePermanently = "Non (les fichiers seront supprimés de l'application et pourront être récupérés manuellement par l'administrateur·trice du serveur)";
$SelectAResponsible = "Sélectionnez un·e superviseur·euse";
$ThereIsNotStillAResponsible = "Aucun·e superviseur·euse disponible";
$AllowStudentsToBrowseCoursesTitle = "Accès des apprenant·es au catalogue de cours";
...
$Name = "Nom";
$Comment = "Voici notre point de vue";
$Visible = "Visible";
