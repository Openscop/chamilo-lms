...
$strings['yearly_cost_limit'] = 'Limite d\'unités de taxe';
$strings['yearly_cost_limit_help'] = "La limite d\'unités de taxe à utiliser pour des cours dans l\'année calendrier actuelle.";
$strings['yearly_hours_limit'] = 'Limite d\'heures académiques';
$strings['yearly_hours_limit_help'] = "La limite d\'heures académiques de cours qui peuvent être suivies en une année calendrier.";
...
$strings['courses_count_limit'] = 'Limite de sessions';
$strings['courses_count_limit_help'] = "La limite de nombre de cours (sessions) qui peuvent être suivis durant une année calendrier et qui <strong>ne sont pas</strong> le cours d'induction";
...
$strings['min_profile_percentage'] = 'Pourcentage du profil complété minimum requis';
...
$strings['AdvancedSubscriptionNotConnected'] = "Vous n'êtes pas connecté·e à la plateforme. Merci d'introduire votre nom d'utilisateur·trice / mot de passe afin de vous inscrire";
...
$strings['AdvancedSubscriptionCostXLimitReached'] = "Désolé·e, vous avez déjà atteint la limite de %s unités de taxe pour les cours que vous avez suivi cette année";
$strings['AdvancedSubscriptionTimeXLimitReached'] = "Désolé·e, vous avez déjà atteint la limite annuelle du nombre de %s heures pour les cours que vous avez suivi cette année";
$strings['AdvancedSubscriptionCourseXLimitReached'] = "Désolé·e, vous avez déjà atteint la limite annuelle du nombre de cours (%s) à suivre cette année";
$strings['AdvancedSubscriptionNotMoreAble'] = "Désolé·e, vous ne répondez plus aux conditions d'utilisation minimum pour l'inscription à un cours";
...
$strings['AdvancedSubscriptionNoQueue'] = "Vous n'êtes pas inscrit·e dans ce cours";
$strings['AdvancedSubscriptionNoQueueIsAble'] = "Vous n'êtes pas inscrit·e mais vous qualifiez pour ce cours";
...
$strings['AdvancedSubscriptionQueueAdminDisapproved'] = "Désolé, votre inscription a été déclinée par l'administrateur·trice.";
$strings['AdvancedSubscriptionQueueAdminApproved'] = "Félicitations! Votre inscription a été acceptée par l'administrateur·trice.";
...
$strings['MailStudentRequestSelect'] = 'Sélection des demandes d\'inscriptions d\'apprenant·es';
$strings['MailAdminAccept'] = 'Demande d\'inscription acceptée par l\'administrateur·trice';
$strings['MailAdminReject'] = 'Demande d\'inscription déclinée par l\'administrateur·trice';
...
$strings['RecommendedNumberOfParticipants'] = 'Nombre recommandé de participant·es par département';
$strings['PublicationEndDate'] = 'Date de fin de publication';
$strings['Mode'] = 'Modalité';
$strings['Postulant'] = 'Candidat·es';
...
$strings['AreYouSureYouWantToAcceptSubscriptionOfX'] = 'Êtes-vous certain·e de vouloir accepter l\'inscription de %s?';
$strings['AreYouSureYouWantToRejectSubscriptionOfX'] = 'Êtes-vous certain·e de vouloir refuser l\'inscription de %s?';
...
$strings['MailContentAdminAcceptToSuperior'] = 'L\'inscription de <strong>%s</strong> au cours <strong>%s</strong> qui démarre le <strong>%s</strong>, qui était en attente de validation par les organisateur·trices du cours, vient d\'être validée. Nous espérons que vous nous donnerez un coup de main pour assurer la disponibilité complète de votre collaborateur·trice pour toute la durée du cours';
...
$strings['MailContentSuperiorAcceptToAdmin'] = 'La inscripción del alumno <strong>%s</strong> al curso <strong>%s</strong> ha sido aprobada por su superior. Puede gestionar las inscripciones al curso <a href="%s"><strong>aqui</strong></a>';
...
$strings['MailContentStudentRequestNoSuperiorToAdmin'] = 'La inscripción del alumno <strong>%s</strong> al curso <strong>%s</strong> ha sido aprobada por defecto, a falta de superior. Puede gestionar las inscripciones al curso <a href="%s"><strong>aqui</strong></a>';
...
$strings['MailContentReminderStudentSecond'] = 'Su inscripción todavia no ha sido aprobada por su superior, por lo que hemos vuelto a enviarle un correo electrónico de recordatorio.';
